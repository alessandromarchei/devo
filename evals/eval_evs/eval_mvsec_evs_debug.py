...
from utils.eval_utils import assert_eval_config, run_voxel_debug
...
def evaluate(config, args, net, train_step=None, datapath="", split_file=None, 
    ...
    for i, scene in enumerate(scenes):
        ...
        for trial in range(trials):
            ...
            # run the slam system
            traj_est, tstamps, flowdata, _ = run_voxel_debug(datapath_val, config, net, viz=viz, 
            ...
            hyperparam = (train_step, net, dataset_name, scene, trial, cfg, args, _)
...
if __name__ == '__main__': 
    ...
    # args.plot = True
    kwargs = {"dim_inet": args.dim_inet, "dim_fnet": args.dim_fnet, "logname": args.logname}
    print("kwargs", kwargs)
