...
class Scorer(nn.Module):
    def __init__(self, bins=5, **kwargs) -> None:
        super().__init__()
    ...
    def forward(self, x):
        ...
        log_stats(scores, "scorer", self.logname)
...
class PatchSelector():
    ...
    def _multi(self, scores, patches_per_image):
        ...
        log_stats(avg_scores, "avg_scores", self.logname)
        ...
        if self.grid:
            ...
            log_stats(scores_grid, "scores_grid", self.logname)
            ...
            log_stats(scores_grid, "scores_t", self.logname)
            ...
            log_stats(idx, "idx", self.logname)
        else:
        ...
        log_stats(x_offset, "x_offset", self.logname)
    ...
    def __call__(self, scores, patches_per_image):
        ...
        log_stats(x, "x", self.logname)
        log_stats(y, "y", self.logname)
        return (x,y)
