...
from .extractor_ours import BasicEncoder4Evs
...
class Patchifier(nn.Module):
    ...
    def forward(self, images, patches_per_image=96, disps=None, return_color=False, scorer_eval_mode="multi", scorer_eval_use_grid=True):
