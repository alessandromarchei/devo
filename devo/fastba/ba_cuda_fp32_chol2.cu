    ...
    const int t0, const int t1, const int iterations)
{
  ...
  for (int itr=0; itr < iterations; itr++) {
    ...
    if (t1 - t0 == 0) {
      ...
      if (itr == 0) std::remove("bef_cast.txt");
      //if (itr == 0) print_2d
      if (itr == 0) print_2d_tensor_to_file(S, "bef_cast.txt", itr);
      ...
      if (itr == 0) std::remove("post_cast.txt");
      //if (itr == 0) print_2d
      if (itr == 0) print_2d_tensor_to_file(S, "post_cast.txt", itr);
      ...
      if (itr == 0) std::remove("L_cast.txt");
      //if (itr == 0) print_2d
      if (itr == 0) print_2d_tensor_to_file(L, "L_cast.txt", itr);
