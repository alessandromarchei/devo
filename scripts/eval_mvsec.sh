...
# Fixed paths
DATAPATH="/usr/scratch/badile13/amarchei/mvsec/indoor_flying"
CONFIG="config/eval_mvsec.yaml"
EVAL_SCRIPT="evals/eval_evs/eval_mvsec_evs.py"
LOG_DIR="logs/eval"
...
for model_folder in "${models[@]}"; do
  ...
  csv_name="eval_mvsec_${model_folder}.csv"
  log_file="${LOG_DIR}/${model_folder}_mvsec.txt"
