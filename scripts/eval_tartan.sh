...
CONFIG="config/eval_tartan.yaml"
EVAL_SCRIPT="evals/eval_evs/eval_tartan_evs.py"
LOG_DIR="logs/eval"
...
for model_folder in "${models[@]}"; do
  ...
  csv_name="eval_tartan_${model_folder}.csv"
  log_file="${LOG_DIR}/${model_folder}_tartan.txt"
