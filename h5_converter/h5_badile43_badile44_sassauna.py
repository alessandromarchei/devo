...
def main():
    ...
    #recreate the bondone path : from /usr/scratch/badile43/amarchei/TartanEvent/office2/Easy/P010/event_frames to /usr/scratch2/bondone/amarchei/TartanEvent/office2/Easy/P010/event_frames
    bondone_path = args.h5.replace("/usr/scratch/badile43/amarchei", "/usr/scratch2/bondone/amarchei")
    event_frames_dir = event_frames_dir.replace("/usr/scratch/badile43/amarchei", "/usr/scratch/badile44/amarchei")
    event_voxel_dir = event_voxel_dir.replace("/usr/scratch/badile43/amarchei", "/usr/scratch/badile44/amarchei")
    ...
    output_dir = output_dir.replace("/usr/scratch/badile43/amarchei", "/usr/scratch/badile44/amarchei")
