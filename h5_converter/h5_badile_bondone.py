...
def main():
    ...
    event_frames_dir = event_frames_dir.replace("/usr/scratch/badile43/amarchei", "/usr/scratch2/bondone/amarchei")
    event_voxel_dir = event_voxel_dir.replace("/usr/scratch/badile43/amarchei", "/usr/scratch2/bondone/amarchei")
    ...
    output_dir = output_dir.replace("/usr/scratch/badile43/amarchei", "/usr/scratch2/bondone/amarchei")
